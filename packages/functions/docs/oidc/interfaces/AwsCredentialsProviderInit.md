...
Defined in: [packages/functions/src/oidc/aws-credentials-provider.ts:20](https://github.com/deryasdeepseeartbounty/vercel/blob/main/packages/functions/src/oidc/aws-credentials-provider.ts#L20)
